namespace GasyTek.Lakana.WPF.Services
{
    ...
    public struct NavigationInfo
    {
        ...
        /// </value>
        public bool ShowAsOpenedView { get; private set; }

        private NavigationInfo(string viewKey, string parentViewKey, object viewModel, bool showAsOpenedView)
            : this()
        {
            ViewKey = viewKey;
            ParentViewKey = parentViewKey;
            ViewModel = viewModel;
            ShowAsOpenedView = showAsOpenedView;
        }
